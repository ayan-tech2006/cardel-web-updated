...
function loadFromStorage() {
    ...
    materials: {
                metal: [
                    { id: 'gunmetal', name: 'Black Metal Matte', color: '#0a0a0a', thickness: '0.8mm', weight: '28g', finish: 'Brushed Matte', price: 0, desc: 'Premium black stainless steel with sophisticated brushed finish' },
                    { id: 'gold22k', name: 'Gold Mirror', color: '#d4af37', thickness: '0.8mm', weight: '28g', finish: 'Polished Mirror', price: 150, desc: '24k gold-plated with mirror-like reflectivity' },
                    { id: 'silver', name: 'Silver Brushed', color: '#c0c0c0', thickness: '0.8mm', weight: '28g', finish: 'Brushed Satin', price: 150, desc: 'Sterling silver-plated with elegant texture' },
                    { id: 'rose', name: 'Rose Gold', color: '#b76e79', thickness: '0.8mm', weight: '28g', finish: 'Polished', price: 175, desc: '18k rose gold with warm contemporary appeal' }
                ],
                wood: [
                    ...
                    { id: 'mahogany', name: 'Mahogany', color: '#5a2d0c', thickness: '0.9mm', weight: '14g', finish: 'Natural Oil', price: 80, desc: 'Rich mahogany with a deep semi-gloss finish' }
                ],
                carbon: [
                    { id: 'cf-black', name: 'Carbon Fiber Weave', color: '#1a1a1a', thickness: '0.6mm', weight: '20g', finish: 'Twill Weave', price: 100, desc: 'Aerospace-grade with signature 2x2 pattern' },
...
function getTextColorsForMaterial(materialId) {
    ...
    // Explicit 50% Brightness Check
    // If the material is light (Silver, Maple, Mother of Pearl), use Dark Charcoal.
    // If dark (Carbon, Black Metal), use Gold/White.
    ...
    if (isDark) {
        ...
        return {
            primary: '#1a1a1a', // High-contrast charcoal
            secondary: '#4a4a4a',
            accent: '#8a7038',  // Deeper gold for light backgrounds
...
function drawHDRFrontSide(ctx, w, h, mat, isDark) {
    ...
    // Get high-contrast colors dynamically
    const colors = getTextColorsForMaterial(mat.id);
    const textColor = colors.primary;
    const subTextColor = colors.secondary;
...
function drawPremiumQR(ctx, x, y, size) {
    ...
    const darkMaterials = ['black-metal', 'carbon-fiber', 'forged-carbon', 'walnut', 'ebony', 'meteorite'];
